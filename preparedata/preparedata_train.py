...
url = "http://localhost:8080/api/getstar"
...
path = r'E:\projectAI\preparedata\dataset\train'
list_data = []
i = 0
...
write_path = r"E:\projectAI\preparedata\model\star_train.pkl"
pickle.dump(list_data, open(write_path, "wb"))
print("data preparation train is done")
